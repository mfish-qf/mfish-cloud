...
public class LogAdvice {
    ...
    @Before("@annotation(cn.com.mfish.oauth.core.annotation.LogAnnotation)")
    ...
    @AfterReturning(value = "@annotation(cn.com.mfish.oauth.core.annotation.LogAnnotation)", returning = "returnValue")
    public void doAfterReturning(Object returnValue) {
        setReturn(0, JSON.toJSONString(returnValue));
    }

    @AfterThrowing(value = "@annotation(cn.com.mfish.oauth.core.annotation.LogAnnotation)", throwing = "e")
